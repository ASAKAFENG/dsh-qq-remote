...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      ...
      rNapcat: "⚠️ NapCat 未启动 —— 请先安装并启动 NapCat（见 README 前置依赖），并在其 WebUI 配置 127.0.0.1:3001 的 WebSocket 服务端",
    ...
    var en = {
      ...
      rNapcat: "⚠️ NapCat not running — install & start NapCat first (see README prerequisites), configure WebSocket server on 127.0.0.1:3001 in its WebUI",
